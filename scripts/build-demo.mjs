...
const relativeOutput = path.relative(path.join(repoRoot,"dist"),outputRoot);
if (!relativeOutput || relativeOutput.startsWith("..") || path.isAbsolute(relativeOutput)) throw new Error("Demo output must be a subdirectory of this project's dist directory");
