...
const RepositoryURL = "https://github.com/zJay26/claude-usage"
const LatestURL = "https://api.github.com/repos/zJay26/claude-usage/releases/latest"
...
func get(ctx context.Context, client *http.Client, raw string, limit int64, out io.Writer) error {
	...
	req.Header.Set("User-Agent", "claude-usage-updater")
